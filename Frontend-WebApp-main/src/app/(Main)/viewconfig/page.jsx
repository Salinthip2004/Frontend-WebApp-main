    ...
    <div className="flex h-screen">
      ...
      >
        ...
        <p className="mb-6 text-transparent inline-block mr-9 px-3 py-2 rounded-full">
          <span className={`text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#cd9ffa] via-[#cd9ffa] to-[#eea684] ${poppins.className}`}>
            64050702_salinthip
          </span>
        </p>
      ...
      <div className="flex flex-col flex-1 min-h-screen bg-slate-100 p-2">
        ...
        <div className="w-full flex flex-wrap items-center space-x-2 md:text-nowrap bg-white shadow-md p-4 rounded-tl-3xl font-semibold text-gray-900 text-sm md:text-lg">
          <Link href="/#" className={`hover:text-gray-500 transition-all duration-200 ${poppin4.className}`}>
            <span>Main</span>
          </Link>
          <ChevronRight className="w-3 h-3 text-gray-500" />
          <Link href="/viewconfig" className={`inline-block bg-stone-100 px-3.5 rounded-full transition-all duration-200 ${poppin4.className}`}>Config</Link>
          <ChevronRight className="w-3 h-3 text-gray-500" />
          <Link href="/temp" className={`hover:text-gray-500 transition-all duration-200 ${poppin4.className}`}>Temp Logs Record</Link>
          <ChevronRight className="w-3 h-3 text-gray-500" />
